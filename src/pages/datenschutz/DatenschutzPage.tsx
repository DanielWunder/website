...
const DatenschutzPage = () => {
  return (
    <Container>
      ...
      <p>
        Unser Hoster erfasst in sogenannten Logfiles die folgenden Daten, die
        von Ihrem Browser übermittelt werden:
      </p>
      <p style={{ display: "flex", justifyContent: "center" }}>
        <ul style={{ margin: 0 }}>
          <li>IP-Adresse</li>
          <li>Adresse der zuvor besuchten Website (Referer-Anfrage-Header)</li>
          <li>Datum und Uhrzeit der Anfrage</li>
          <li>Zeitzonendifferenz zur Greenwich Mean Time</li>
          <li>Inhalt der Anforderung</li>
          <li>HTTP-Statuscode</li>
          <li>Übertragene Datenmenge</li>
          <li>Website, von der die Anforderung stammt</li>
          <li>Informationen zum Browser und Betriebssystem</li>
        </ul>
      </p>
      <p>
        Diese Datenerfassung ist erforderlich, um unsere Website anzuzeigen und
        ihre Stabilität sowie Sicherheit zu gewährleisten. Sie entspricht
        unserem berechtigten Interesse gemäß Art. 6 Abs. 1 S. 1 lit. f DSGVO. Es
        erfolgt kein Tracking, und wir haben keinen direkten Zugriff auf diese
        Daten.
      </p>
      <p>
